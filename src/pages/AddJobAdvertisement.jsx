...
export default function AddJobAdvertisement() {
  const workTypes = [
    { text: "Çalışma Türünü Seçiniz" },
    { text: "İş Yerinden", value: "İş Yerinden" },
    { text: "Uzaktan", value: "Uzaktan" },
  ];
  const workTimes = [
    { text: "Çalışma Zamanı Seçiniz" },
